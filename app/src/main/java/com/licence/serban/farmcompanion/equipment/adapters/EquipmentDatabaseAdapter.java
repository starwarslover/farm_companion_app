...
public class EquipmentDatabaseAdapter {
  ...
  private ChildEventListener equipListener;
  ...
  public void setListener(final EquipmentListAdapter adapter) {
    equipListener = new ChildEventListener() {
      @Override
    ...
    equipmentReference.addChildEventListener(equipListener);
  }

  public void removeListener() {
    equipmentReference.removeEventListener(equipListener);
  }
