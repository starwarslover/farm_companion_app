...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navNameTextView = (TextView)findViewById(R.id.navNameTextView);
        navEmailTextView = (TextView)findViewById(R.id.navEmailTextView);
        navCompanyNameTextView = (TextView)findViewById(R.id.navCompanyTextView);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        userID = getIntent().getStringExtra(Utilities.Constants.USER_ID);
